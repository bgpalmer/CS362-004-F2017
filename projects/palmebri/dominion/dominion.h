...
struct gameState {
  ...
  int embargoTokens[treasure_map+1]; // 55
  int outpostPlayed; // 56
  int outpostTurn; //57
  int whoseTurn; //58
  int phase; //59
  int numActions; /* Starts at 1 each turn */ //60
  int coins; /* Use as you see fit! */ // 61
  int numBuys; /* Starts at 1 each turn */ //62
